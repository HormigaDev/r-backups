...
Para que o CLI funcione corretamente, você deve ter as seguintes variáveis de ambiente configuradas em um arquivo `.env` no diretório onde usará o CLI ou nas variáveis de ambiente do sistema.
